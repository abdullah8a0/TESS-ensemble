...
import os
from lcobj import LC, LCMissingDataError, LCOutOfBoundsError, gen_path, LC,get_coords_from_path
        ...
        with open(f'Features\\features{sector2}_{cam}_{ccd}_s.txt', 'w') as file, os.scandir(path) as entries:
            for i,entry in enumerate(entries):
                ...
                # Days of interest
                    ...
                    coords = get_coords_from_path(file_path)
...
if __name__ == '__main__':
    sector = 34
    extract_scaler_features(sector)