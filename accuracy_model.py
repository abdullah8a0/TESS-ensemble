...
# with H1
to_names_map_partial = {0: 'better_amp', 1: 'med', 2: 'mean', 3: 'std', 4: 'skew', 5: 'max_slope', 6: 'delta_quartiles', 7: 'flux_mid_50', 8: 'cons', 9: 'var_ind', 10: 'med_abs_dev', 11: 'H1', 12: 'R31', 13: 'Rcs', 14: 'l', 15: 'StetK', 16: 'days_of_i', 17: 'rms'}
to_index_map_partial = {'better_amp': 0, 'med': 1, 'mean': 2, 'std': 3, 'skew': 4, 'max_slope': 5, 'delta_quartiles': 6, 'flux_mid_50': 7, 'cons': 8, 'var_ind': 9, 'med_abs_dev': 10, 'H1': 11, 'R31': 12, 'Rcs': 13, 'l': 14, 'StetK': 15, 'days_of_i': 16, 'rms': 17}
